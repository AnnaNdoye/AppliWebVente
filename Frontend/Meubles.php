        ...
        <div class="products-grid">
            ...
            <div class="product-card" data-product="1">
                <div class="product-img">
                    <img src="https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Y2hhaXNlfGVufDB8fDB8fHww" alt="Chaise">
                    <span class="product-badge">Nouveau</span>
                </div>
                <div class="product-info">
                    <h3>Chaise blanche</h3>
                    <p class="product-description">Chaise disponible en plusieurs couleurs.</p>
                    <div class="product-price">15 000 CFA</div>
                    <div class="product-origin">
                        <img src="  https://flagcdn.com/48x36/sn.png" alt="Senegal"> Fabriqué au SENEGAL
                    </div>
            ...
            <div class="product-card" data-product="3">
                <div class="product-img">
                    <img src="https://plus.unsplash.com/premium_photo-1681046751108-a516bea00570?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGNhbmFwZXxlbnwwfHwwfHx8MA%3D%3D" alt="Tapis Berbère">
                    <span class="product-badge">Best-seller</span>
                </div>
                <div class="product-info">
                    <h3>Canape deux places</h3>
                    <p class="product-description">Canape en tissu .</p>
                    <div class="product-price">250 000 CFA</div>
                    <div class="product-origin">
                        <img src="https://flagcdn.com/w20/ma.png" alt="Maroc"> Fabriqué au Maroc
                    </div>
                    <div class="product-details">140x200 cm · </div>
                    <div class="product-actions">
    ...
    <div id="productModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalProductTitle">CHAISE</h2>
                ...
                <div class="modal-product">
                    <div class="modal-product-images">
                        <div class="modal-thumbnails">
                            ...
                            <img src="https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Y2hhaXNlfGVufDB8fDB8fHww" alt="Tapis Persan motif" class="modal-thumbnail" onclick="changeMainImage(this)">
                        </div>
                        <img src="https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8Y2hhaXNlfGVufDB8fDB8fHww" alt="Tapis Persan" class="modal-main-image">
                    </div>
                    <div class="modal-product-info">
                        <h3 id="modalProductName">Chaise</h3>
