...
<body>
    <header>
        ...
        <div class="collection-header">
            <h1>Collection DECO MURAL</h1>
            <p>Découvrez notre sélection exclusive de Tableau pour apporter chaleur, élégance et confort à votre intérieur.</p>
        </div>
        ...
        <div class="products-grid">
            ...
            <div class="product-card" data-product="1">
                <div class="product-img">
                    <img src="https://images.unsplash.com/photo-1579273168832-1c6639363dad?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dGFibGVhdXxlbnwwfHwwfHx8MA%3D%3D" alt="Tapis Persan">
